...
package com.ibm.research.kar.reefer.client.orderdriver.json;


import com.ibm.research.kar.reefer.client.orderdriver.model.Route;
import com.ibm.research.kar.reefer.client.orderdriver.model.Ship;
...
public class VoyageJsonSerializer {
    ...
    public static Voyage deserialize(JsonObject jsonVoyage) {
        ...
        if ( jsonVoyage.containsKey(Voyage.ARRIVAL_PUBLISHED)) {
